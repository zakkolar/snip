...
function createFormFolder() {
    initAppFolder();
    var folder = getAppFolder().createFolder(getFormTitle());
 ...
 */
function saveImage(blob, folder, mode, question_number, response) {
 ...
 */
function generateImageName(folder, mode, question_number, response, noCount) {
 ...
 * @param response Boolean indicating whether image is a response (only required for image mode)
 */
function saveCrop(imgString, mode, question_number, response) {
    var blob = getBlobFromEmbed(imgString);
